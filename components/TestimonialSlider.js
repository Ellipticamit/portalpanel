...
function TestimonialSlider(props) {
  ...
  return (
    <div className='testimonials-carousel1 owl-carousel owl-theme owl-btn owl-btn-white owl-btn-center'>
        ...
        >
          <div className='testimonial'>
            <div className='testimonial-text'>
              <p>
                “Aenean massa diam, sollicitudin non dui ut, facilisis viverra
                libero. Nulla facilisi. Nunc sed purus erat. Praesent placerat
                dictum libero, eu varius nulla vulputate non”
              </p>
            </div>
